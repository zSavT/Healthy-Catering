...
public class OkBoxVideo : MonoBehaviour
{
    ...
    List<string> testi = new List<string>
    {
        ...
        "Per fare rifornimenti di " + Utility.coloreIngredienti + "ingredienti " + Utility.fineColore + "visita il " + Utility.coloreVerde + "negozio " + Utility.fineColore + "dove acquistare gli "  + Utility.coloreIngredienti + "ingredienti " + Utility.fineColore + "necessari a realizzare altri " + Utility.colorePiatti + "piatto " + Utility.fineColore + "con i soldi guadagnati. Ora raggiungi il negozio e compra un " + Utility.coloreIngredienti + "ingredienti" + Utility.fineColore + ".",
        "Interagire con i <color=#B5D99C>passanti</color> in giro per la città ti permette di ottenere <color=#B5D99C>suggerimenti</color> utili per servire " + Utility.colorePiatti + "piatto " + Utility.fineColore + "migliori, sia dal punto di vista dell'affinità con le " + Utility.colorePatologia + "patologie" + Utility.fineColore + " che da quello del<color=#B5D99C> nutriScore</color> e del<color=#B5D99C> costoEco</color>. Ora prova a parlare con una persona.",
        "Puoi utilizzare il ricettario quando vuoi ed in ogni punto della mappa, premi il tasto “" + Utility.coloreVerde + "R" + Utility.fineColore + "” per visualizzarlo. Puoi utilizzare il " + Utility.coloreVerde + "ricettario" + Utility.fineColore + " per visionare le quantità degli " + Utility.coloreIngredienti + "ingredienti " + Utility.fineColore + "di un " + Utility.colorePiatti + "piatto " + Utility.fineColore + ", oltre a poter visionare il <color=#B5D99C>nutriScore</color> e <color=#B5D99C>costoEco</color> nella scheda tecnica del " + Utility.colorePiatti + "piatto " + Utility.fineColore + " o " + Utility.coloreIngredienti + "ingredienti" + Utility.fineColore + ".",
        "Puoi consultare il menu aiuto quando vuoi ed in ogni punto della mappa, premi il tasto “" + Utility.coloreVerde + "H" + Utility.fineColore + "” per visualizzarlo. Puoi ri-visionare tutte le informazioni e le meccaniche del gioco mostrate in precedenza.",
    };
