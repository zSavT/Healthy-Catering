...
public class OkBoxVideo : MonoBehaviour
{
    ...
    {
        "Per muoversi all’interno del gioco, bisogna usare rispettivamente " + Utility.coloreVerde + "“W”" + Utility.fineColore + " per andare avanti, " + Utility.coloreVerde + "“S”" + Utility.fineColore + " per andare indietro, " + Utility.coloreVerde + "“A”" + Utility.fineColore + " per andare a sinistra, " + Utility.coloreVerde + "“D”" + Utility.fineColore + " per andare a destra. Il giocatore si muove verso la direzione inquadrata con il " + Utility.coloreVerde + "“mouse”.",
        "Per saltare all'interno del gioco bisogna premere il tasto" + Utility.coloreVerde + " Spazio" + Utility.fineColore + ".",
        "Per correre all'interno del gioco bisogna premere il tasto" + Utility.coloreVerde + " Shift" + Utility.fineColore + ".",
        "Raggiungi tuo zio e interagisci con lui. Per interagire con una persona devi premere " + Utility.coloreVerde + "“E“" + Utility.fineColore + ".",
        "Per entrare o uscire nel tuo ristorante devi premere il tasto " + Utility.coloreVerde + "“E“" + Utility.fineColore + " una volta inquadrato la porta con il mouse.",
        ...
        "Servire un <color=#B5D99C> piatto</color> non idoneo, comporta delle penalità al punteggio e non si riceveranno bonus in denaro. I bonus e i malus, vengono calcolati in base alla compatibilità del piatto ed al volore dei <color=#B5D99C> nutriScore</color> e <color=#B5D99C> costoEco</color> di questi ultimi.",
        "É importante controllare il <color=#B5D99C> magazzino</color> del negozio, per controllare quali ingredienti sono disponibili per poter realizzare i piatti. Infatti servire un piatto, scala dal magazzino la quantità necessaria degli ingredienti. É possibile visionare lo stato del magazzino nel <color=#B5D99C> PC</color> presente in <color=#B5D99C> ufficio</color>.",
        "Per fare rifornimenti di ingredienti, bisogna visitare il negozio ed acquistare gli ingredienti desiderati per realizzare nuovi piatti, acquistandoli con i soldi guadagnati dal ristorante.",
        "Interagire con gli <color=#B5D99C>NPC</color> in giro per la città permette di ottenere <color=#B5D99C>suggerimenti</color> utili per servire piatti migliori, sia dal punto di vista dell'affinità le patologie che dal punto di vista del <color=#B5D99C> nutriScore</color> e dell'<color=#B5D99C> costoEco</color>."
    };
