...
public class Costanti
{
    ...
    public static readonly List<string> testiMenuAiuto = new List<string>
    {
        ...
        "Interagire con i " + Costanti.coloreVerde + "passanti" + Costanti.fineColore + " in giro per la città permetterà di ottenere <color=#B5D99C>suggerimenti</color> utili per servire piatti migliori, sia dal punto di vista dell’affinità le patologie che dal punto di vista del " + Costanti.coloreVerde + "nutriScore" + Costanti.fineColore +  " e dell'" + Costanti.coloreVerde +  "costoEco" + Costanti.fineColore + ".",
