...
public class Costanti
{
    ...
    public static readonly List<string> testiMenuAiuto = new List<string>
    {
        ...
        "I bonus della vendita del " + Costanti.colorePiatti + "piatto" + Costanti.fineColore + " è calcolato come segue: prezzo finale = prezzo base (somma dei costi di tutti gli ingredienti + 10%) + bonus affinità (+5% se il piatto è affine al cliente, -5% se non lo è) + extra bonus pari al 3%, 2% o 1% se il " + Costanti.colorePiatti + "piatto" + Costanti.fineColore + " servito è rispettivamente il primo, secondo o terzo migliore servibile. Il puntegggio invece parte da 100 se viene servito un piatto affine, -10 altrimenti. Vengono aggiunti bonus in base al " + Costanti.coloreVerde + "nutriScore" + Costanti.fineColore + " e al " + Costanti.coloreVerde + "costoEco" + Costanti.fineColore + " calcolati come segue:",
        ...
        "Ad inizio livello vengono visualizzati i criteri di vittoria e Game Over. Come ad esempio servire un numero X di clienti e raggiungere un punteggio pari a Y. É possibile visionare il progresso degli obbiettivi in alto a destra. Una volta superati tutti gli obbiettivi, il livello è considerato terminato e si avvia la schermata di fine livello, dopo è visibile un breve riepilogo ed tasto per tornare al menu principale. Il Game Over, invece, avviene se dopo X clienti serviti, non si raggiungono gli obbiettivi prefissati, oppure non si ha a disposizione il denaro sufficiente per comperare ingredienti. In tal caso, si avvia la schermata di Game Over, dove è possibile tornare al menu principale."
    };
