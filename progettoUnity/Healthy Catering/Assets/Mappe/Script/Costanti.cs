...
public class Costanti
{
    ...
    public static readonly List<string> testiMenuAiuto = new List<string>
    {
        ...
        "I bonus della vendita del " + Costanti.colorePiatti + "piatto" + Costanti.fineColore + " è calcolato come segue:\n" + Costanti.coloreVerde + "Prezzo finale" + Costanti.fineColore + " = prezzo base (somma costo di tutti gli ingredienti + 10%)\n+ bonus affinità (+5% se il piatto è affine al cliente, -5% se non lo è)\n+ extra bonus (3%, 2% o 1% se il " + Costanti.colorePiatti + "piatto" + Costanti.fineColore + " servito è rispettivamente il primo, secondo o terzo migliore servibile).\n" + Costanti.coloreVerde + "Puntegggio" + Costanti.fineColore + " = Valore base (100 se viene servito un piatto affine, -10 altrimenti). Vengono aggiunti bonus in base al " + Costanti.coloreVerde + "nutriScore" + Costanti.fineColore + " e al " + Costanti.coloreVerde + "costoEco" + Costanti.fineColore + " calcolati come segue:",
        ...
        "Ad inizio livello vengono visualizzati i criteri di " + Costanti.coloreVerde + "vittoria" + Costanti.fineColore + " e " + Costanti.coloreVerde + "Game Over" + Costanti.fineColore + ". Come ad esempio servire un numero X di " + Costanti.coloreVerde + "clienti" + Costanti.fineColore + " e raggiungere un " + Costanti.coloreVerde + "punteggio" + Costanti.fineColore + " pari a Y. É possibile visionare il progresso degli obbiettivi in alto a destra. Una volta superati tutti gli obbiettivi, il livello è considerato terminato e si avvia la schermata di fine livello, dopo è visibile un breve riepilogo ed tasto per tornare al menu principale. Il " + Costanti.coloreVerde + "Game Over" + Costanti.fineColore + ", invece, avviene se dopo X " + Costanti.coloreVerde + "clienti" + Costanti.fineColore + " serviti, non si raggiungono gli obbiettivi prefissati, oppure non si ha a disposizione il " + Costanti.coloreVerde + "denaro sufficiente" + Costanti.fineColore + " per comperare " + Costanti.coloreIngredienti + "ingredienti" + Costanti.fineColore + ". In tal caso, si avvia la schermata di Game Over, dove è possibile tornare al menu principale."
    };
