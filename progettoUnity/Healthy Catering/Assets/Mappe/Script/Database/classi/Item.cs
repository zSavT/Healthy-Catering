...
public class Item
{
    ...
    public Item(int idIngrediente, string nome, string descrizione)
    {
    ...
    {
        this.idIngrediente = Database.getNewId<Item>(this);
        this.nome = nome;
    }
    ...
    public static Item creaNuovoItem(string nome = null)
    {
