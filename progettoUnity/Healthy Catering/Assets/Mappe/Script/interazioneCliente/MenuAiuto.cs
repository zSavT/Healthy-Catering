...
public class MenuAiuto : MonoBehaviour
{
    ...
    private List<string> messaggiDiAiuto = new List<string>
    {
        ...
        "Sarà possibile scegliere <color=#B5D99C>solo i piatti</color> per i quali <color=#B5D99C>sono disponibili tutti gli ingredienti nelle quantità necessarie</color>; quindi, si dovrà tenere conto degli ingredienti disponibili nel proprio magazzino e comprare gli ingredienti mancanti. É possibile visionoare lo stato del magazzino aprendo il programma <color=#B5D99C>\"MyInventory\"</color>, accessibile nel computer presente nell'ufficio del ristorante.",
        ...
        "Per acquistare nuovi ingredienti per il ristorante, bisogna recarsi al negozio. Interagendo con il negoziante, sarà possibile scegliere gli ingredienti da acquistare con i soldi a disposizione."
