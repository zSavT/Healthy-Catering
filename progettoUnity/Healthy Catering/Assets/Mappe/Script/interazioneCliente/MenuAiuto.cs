...
public class MenuAiuto : MonoBehaviour
{
    ...
    {
        "Utilizza i tasti \"" + Utility.coloreVerde + "W" + Utility.fineColore + "\", \"" + Utility.coloreVerde + "A" + Utility.fineColore + "\", \"" + Utility.coloreVerde + "S" + Utility.fineColore + "\", " + Utility.coloreVerde + "D" + Utility.fineColore + "\" per muoveti rispettivamente in \"" +Utility.coloreVerde + "Avanti" + Utility.fineColore + "\", \"" + Utility.coloreVerde + "Sinistra" + Utility.fineColore + "\", \"" + Utility.coloreVerde + "Indietro" + Utility.fineColore + "\", \"" + Utility.coloreVerde + "Destra" + Utility.fineColore + "\". In più premi il tasto \"" + Utility.coloreVerde + "Spazio" + Utility.fineColore + "\" per saltare e tieni premuto il tasto \"" + Utility.coloreVerde + "Shift" + Utility.fineColore + "\" per correre mentre ti muovi.",
        "Per avviare l'interazione con un " + Utility.coloreVerde + "cliente" + Utility.fineColore +" al bancone inquadralo e premi il tasto \"" + Utility.coloreVerde + "E" + Utility.fineColore + "\". Per servire i clienti utilizza il mouse e selezionare il " + Utility.colorePiatti + "piatto" + Utility.fineColore + " da servire al cliente quando richiesto attraverso la relativa schermata.",
        "Scegliere il piatto migliore fra quelli disponibili ti permette di aumentare il tuo denaro e il tuo punteggio, così da poter superare il livello. Nel caso dovessi servire ad un <color=#B5D99C>cliente</color> con una certa " + Utility.colorePatologia + "patologia" + Utility.fineColore + " e/o " + Utility.coloreDieta + "dieta"  + Utility.fineColore + " un " + Utility.colorePiatti+ "piatto" + Utility.fineColore + " dove è presente un " + Utility.coloreIngredienti + "ingrediente" + Utility.fineColore + " non compatibile con essa, verrà mostrato un pop up in cui potrai visualizzare quali degli " + Utility.coloreIngredienti + "ingrediente" + Utility.fineColore + " del " + Utility.colorePiatti + "piatto" + Utility.fineColore + " sono compatibili con la " + Utility.colorePatologia + "patologia" + Utility.fineColore + " e quali no.",
        ...
        "I bonus della vendita del " + Utility.colorePiatti + "piatto" + Utility.fineColore + " è calcolato come segue: prezzo finale = prezzo base (somma dei costi di tutti gli ingredienti + 10%) + bonus affinità (+5% se il piatto è affine al cliente, -5% se non lo è) + extra bonus pari al 3%, 2% o 1% se il " + Utility.colorePiatti + "piatto" + Utility.fineColore + " servito è rispettivamente il primo, secondo o terzo migliore servibile. Il puntegggio invece parte da 100 se viene servito un piatto affine, -10 altrimenti. Vengono aggiunti bonus in base al <color=#B5D99C>nutriScore</color> e al <color=#B5D99C>costoEco</color> calcolati come segue:",
