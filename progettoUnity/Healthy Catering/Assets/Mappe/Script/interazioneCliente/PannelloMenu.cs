...
public class PannelloMenu : MonoBehaviour
{
    ...
    public void confermaPiattoDaBottone()
    {
        ...
        giocatore.aggiungiDiminuisciPunteggio(affinita, piattoSelezionato.calcolaNutriScore(databaseIngredienti), piattoSelezionato.calcolaCostoEco(databaseIngredienti), giocatore.livelloAttuale);
        ...
        livelloProgresso.servitoCliente(giocatore.punteggio[giocatore.livelloAttuale]);
